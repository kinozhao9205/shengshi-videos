...
const I18N = {
  ...
  UI: {
    ...
    en: {
      ...
      navCases: "Cases",
      navAiVideo: "AI Creative",
      navPromoVideo: "Promo Videos",
      navTeam: "Team",
      navContact: "Contact",
    ...
    uz: {
      ...
      navHistory: "Tariximiz",
      navServices: "Xizmatlar",
      navCases: "Loyihalar",
      navAiVideo: "AI Ijod",
      navPromoVideo: "Reklama Videolari",
      navTeam: "Jamoa",
      navContact: "Aloqa",
  ...
  VIDEOS: {
    ...
    v31: {
      en: { title: "Integrated Experience-Space Automated Exhibits", desc: "SHENGSHI builds integrated experience-space automated exhibits that combine off-road, handling, lifting, and protection in one system — customized units, scientifically matched, and linked by smooth visitor circulation. It adapts efficiently to roadshows at every scale, raising setup efficiency and amplifying brand voice." },
      uz: { title: "Integratsiyalashgan Tajriba Maydoni Avtomatlashtirilgan Jihozlari", desc: "SHENGSHI offroad, boshqaruv, ko'tarish va himoyani bitta tizimda birlashtirgan integratsiyalashgan tajriba maydoni avtomatlashtirilgan jihozlarini yaratadi — moslashtirilgan modullar, ilmiy moslashtirish va uzluksiz mehmon harakati yo'nalishlari. Har qanday masshtabdagi ko'rgazma turlariga samarali moslashib, o'rnatish samaradorligini oshiradi va brend ovozini kuchaytiradi." }
    },
    v30: {
